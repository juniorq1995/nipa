...
#move to interact window
    ...
    def singleStation(self):
        ...
        submit.grid(row = 4,column = 5,sticky = tk.E)

        app.mainloop()

    def multipleStations(self):
        #upload station list
        #upload year list
        #enter/upload thresholds
        #choose variable
        #choose phases
        #####generate maps##########!!!!
        #generate graphs?
        window = tk.Tk()
        window.title("Multi-Station Module Fields")
...
if __name__ == '__main__':
    gui = station_mod_gui2()
    #margin  call
    #prop trading
    #signals trading
    # video games twitch
    #only trade with us brokers
    #demo accounts
    #buying futures
    # forex brexit opportunity
    #metatrader
